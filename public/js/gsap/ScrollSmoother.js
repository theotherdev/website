...
!(function (e, t) {
      ...
      (ScrollSmoother.register = function register(e) {
        return (
          L ||
            ...
            s() &&
              window.document &&
              ((I = window), (j = document), (q = j.documentElement), (B = j.body)),
            F &&
              ((W = F.utils.toArray),
              (Y = F.utils.clamp),
              ($ = F.parseEase("expo")),
              (Q = F.core.context || function () {}),
              (Z = F.core.globals().ScrollTrigger),
              F.core.globals("ScrollSmoother", ScrollSmoother),
              B &&
                Z &&
                ((X = F.delayedCall(0.2, function () {
  ...
  function ScrollSmoother(t) {
    var o = this;
    L || ScrollSmoother.register(F) || console.warn("Please gsap.registerPlugin(ScrollSmoother)"),
      (t = this.vars = t || {}),
      K && K.kill(),
      Q((K = this));
    function Pa() {
    ...
    function Ya(e) {
      (v.scrollTop = 0),
        (e.target.contains && e.target.contains(v)) ||
          (_ && !1 === _(o, e)) ||
          (Z.isInViewport(e.target) || e.target === p || o.scrollTo(e.target, !1, "center center"),
          (p = e.target));
    }
    function Za(t, e) {
          ...
          b.forEach(function (e) {
            ...
            e._startClamp && t < 0
              ...
              : (e.ratio < 0 || (e._endClamp && r >= D())) &&
                (n =
                  ((r = D()) - (t = e.ratio < 0 || 1 < e.ratio ? 0 : r - (r - e.start) / e.ratio)) *
                    e.ratio -
                  (e.end - e.start)),
              (e.offset = n || 1e-4),
    ...
    function fb(r, e, t, n, o) {
        ...
        (e = u()),
          ...
          (c =
            a || (s && s._startClamp && s.start <= 0) || p.offset
              ...
              : 0.5),
          l && l.kill(),
          (l = t && F.to(r, { ease: $, overwrite: !1, y: "+=0", duration: t })),
        ...
        if (a) {
          ...
          var t = (function _autoDistance(e, t) {
            ...
            return (
              0 < c &&
                ((n =
                  0.5 == (r = s.height / (I.innerHeight + s.height))
                    ? 2 * s.height
      ...
      return (
        ...
        (1 !== i || a || l) &&
                ...
                if (e.offset) {
                  if (i) {
                    ...
                    o =
                      h +
                      s +
                      w * ((F.utils.clamp(e.start, e.end, r) - e.start - s) / (n - e.start) - c);
                  }
                  m.length &&
                    !a &&
          ...
          (F.core.getCache(s.trigger).stRevert = db),
          (s.startY = h),
          (s.pins = p),
          (s.markers = m),
          (s.ratio = i),
    ...
    function refreshHeight() {
      return (
        ...
        (B.style.height = I.innerHeight + (e - I.innerHeight) / A + "px"),
        e - I.innerHeight
      );
    }
    bb(),
      ...
      (this.scrollTo = function (e, t, r) {
        ...
        t ? (f ? F.to(o, { duration: k, scrollTop: n, overwrite: "auto", ease: $ }) : E(n)) : Va(n);
      }),
        ...
        if (arguments.length) {
          ...
          return (
            t !== n &&
              ...
              O && O.observe(n),
              F.set(n, { overflow: "visible", width: "100%", boxSizing: "border-box", y: "+=0" }),
      ...
      (i = Z.create({
        ...
        onRefreshInit: function onRefreshInit(e) {
          if (!ScrollSmoother.isRefreshing) {
            ...
            (d = r && r._end > r._dp._time),
              ...
              (z.y = 0),
              k &&
                (1 === Z.isTouch && (v.style.position = "absolute"),
                (v.scrollTop = 0),
                1 === Z.isTouch && (v.style.position = "fixed"));
          }
        },
        onRefresh: function onRefresh(e) {
          e.animation.invalidate(),
            ...
            (z.y = -E() * A),
            Ua(z.y),
            N || (d && (g = !1), e.animation.progress(F.utils.clamp(0, 1, u / A / -e.end))),
          ...
          ? (!!f !== e &&
              (e
                ? (i.getTween() && i.getTween().pause(),
                  ...
                  })).nested = J(q, "wheel,touch,scroll", !0, !1 !== t)))
                : (f.nested.kill(),
                  f.kill(),
                  (f = 0),
                  r && r.enable(),
      ...
      (this.kill = this.revert =
        function () {
          ...
          Z.scrollerProxy(v),
            ...
            (n.style.cssText = c);
          var r = Z.defaults({});
          r && r.scroller === v && Z.defaults({ scroller: I }),
            o.normalizer && Z.normalizeScroll(!1),
            clearInterval(a),
            (K = null),
            O && O.disconnect(),
            B.style.removeProperty("height"),
            I.removeEventListener("focusin", Ya);
        }),
      (this.refresh = function (e, t) {
        return i.refresh(e, t);
      }),
      C && (this.normalizer = Z.normalizeScroll(!0 === C ? { debounce: !0, content: !k && n } : C)),
      Z.config(t),
      "scrollBehavior" in I.getComputedStyle(B) && F.set([B, q], { scrollBehavior: "auto" }),
      I.addEventListener("focusin", Ya),
